...
1.  **[Installation](./getting-started/installation)**
    Learn how to install the package and—more importantly—how to set up the **Wrapper Pattern** (`loom-wrapper.typ`) to keep your project clean.

2.  **[Your First Component](./getting-started/first-component)**
    Write your first piece of code. We will build a styled **Note Box** and learn the difference between standard functions and Loom Motifs.
