...
Loom shines in scenarios where linear top-down layouting is insufficient. If you find yourself needing "global variables" that change based on content, or if parents need to know details about their children *before* rendering, Loom is the right choice.
...
* *Example:* [Character Sheet Showcase]
